...
class T20PerformanceSpider(scrapy.Spider):
    name = "T20_Performance_Table"
 
    def start_requests(self):
        urls = [
            'http://stats.espncricinfo.com/ci/engine/stats/index.html?class=3;filter=advanced;orderby=runs;spanmax1=05+Mar+2019;spanmin1=05+Mar+2018;spanval1=span;team=8;template=results;type=allround',
        ]
        for url in urls:
