...
class Bangladesh(scrapy.Spider):
    name = "Bangladesh"
 
    def start_requests(self):
        #Seperate urls for Test, ODI & T20
        urls = [
            'http://stats.espncricinfo.com/ci/engine/stats/index.html?class=1;opposition=25;spanmin1=05+Mar+2018;spanval1=span;team=8;template=results;type=allround',
            'http://stats.espncricinfo.com/ci/engine/stats/index.html?class=2;opposition=25;spanmin1=05+Mar+2018;spanval1=span;team=8;template=results;type=allround',
            'http://stats.espncricinfo.com/ci/engine/stats/index.html?class=3;opposition=25;spanmin1=05+Mar+2018;spanval1=span;team=8;template=results;type=allround',        ]
        for url in urls:
